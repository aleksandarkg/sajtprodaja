    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		  <div class="row">
				...
				<input type="hidden" name="description" value="<?=$item_count.' item'. (($item_count > 1)? 's' : '').' from Shauntas Botique.';?>">
					<div id="step1" style="display: block;">
						...
						<div class="form-group col-md-6">
							...
							<input class="form-control" type="text" id="state" name="state" data-stripe="address_state">
						</div>
...
<script>
	...
	function check_address(){
		var data = {
			...
			jQuery.ajax({
				url : '/sajtprodaja/admin/parsers/check_address.php',
				method : 'POST',
				data : data,
